...
TECHNO_IMG = "https://telegra.ph/file/4a58ef0dbf877a59552c8.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/royalashu4m")],
                                                                                  InlineKeyboardButton(text="SUBSCRIBE MY CHANNEL",
                                                                       url="https://www.youtube.com/channel/UCUVwM-MsWCZ-FdWQoQYOwiQ")],
                                                                                   [InlineKeyboardButton(text="ADD ROYALASHU TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/royalashu4m/royalashu4")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("are hm jinda hu bhai")
